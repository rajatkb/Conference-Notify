...
2. Install MongoDB with the following Installation instructions.
...
2. For more information, Visit [Pymongo client](https://www.mongodb.com/blog/post/getting-started-with-python-and-mongod
