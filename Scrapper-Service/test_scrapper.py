import unittest
from ..datamodels.conference import Conference
...
class ConferenceTestCase(unittest.TestCase):
    ...
    def test_data(self):
        obj = self.get_conferenceobj()
        expected = {'url': 'http://url.com', '_id': '759839e1-5d29-5c50-91fc-ed182d3112b1', 'deadline': 'deadline', 'metadata.worker': {'website': 'domain_url', 'domain': 'domain_name', 'website_url': 'website_url', 'date_extracted': 'date_extracted'}, 'title': 'title'}
